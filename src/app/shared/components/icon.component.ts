...
// ─── Brand logo (monogramma "P" + lancette orologio + pallino notifica) ───────
// Tratti bianchi, pensato per stare su un tile a gradiente di marca.
@Component({
  ...
  template: `
    <svg
      ...
      <defs>
        <linearGradient id="bl-nd" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stop-color="#FF6B7A"/>
          <stop offset="1" stop-color="#FF4757"/>
        </linearGradient>
      </defs>
      <path d="M17 52 L17 12" stroke="white" stroke-width="5.5" stroke-linecap="round"/>
      <path d="M17 12 L29 12 C38 12 47 17 47 27 C47 37 38 42 29 42 L17 42"
        stroke="white" stroke-width="5.5" stroke-linecap="round" stroke-linejoin="round"/>
      <line x1="32" y1="27" x2="23.3" y2="22" stroke="rgba(255,255,255,0.50)" stroke-width="3" stroke-linecap="round"/>
      ...
      <circle cx="47" cy="12" r="6.5" fill="url(#bl-nd)" stroke="rgba(255,255,255,0.55)" stroke-width="1.8"/>
    </svg>
  `,
})
