...
@Component({
  ...
  styles: [`
    ...
    /* OTP 6-box grid — critical: min-width:0 prevents grid overflow on Android */
    .otp-grid {
      display: grid;
...
export class AuthComponent {
  ...
  async signInGoogle(): Promise<void> {
    ...
    try {
      ...
      // OAuth redirect — session restored via onAuthStateChange
    } catch (err) {
